...
INSERT INTO "new_StockItem" ("createdAt", "description", "id", "location", "minQuantity", "name", "quantity", "sku", "unit", "updatedAt") SELECT "createdAt", "description", "id", "location", "minQuantity", "name", "quantity", "sku", "unit", "updatedAt" FROM "StockItem";
